...
/* List 20 obesrvations for NP_Sumamry */
proc print data= PG1.NP_SUMMARY (obs=20);
	var REG TYPE PARKNAME DAYVISITS TENTCAMPERS RVCAMPERS;
run;

/* Get means for DayVisits TentCampers RvCampers */
PROC MEANS DATA = PG1.NP_SUMMARY;
	VAR DAYVISITS TENTCAMPERS RVCAMPERS;
run;

/* Find extreme(variations) for DayVisits TentCampers RVCampers */
proc univariate data = pg1.np_summary;
	var dayvisits tentcampers rvcampers;
run;	

/* Get frequency of Reg and Type */
